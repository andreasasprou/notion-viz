...
import { createContext, isRunningOnServerSide } from '@/shared';
...
export function Portal(props: PortalProps) {
  ...
  }, [getContainer, portal, parentPortal, onMount, onUnmount, manager && manager.node, append]);
  ...
  return createPortal(
    <PortalContextProvider value={portal}>{finalChildren}</PortalContextProvider>,
    portal
  );
}
