 ...
 * @memberof utils
 */
function isDeepEqual(o1: Record<string, any>, o2: Record<string, any>, _depth = 0) {
  const diffs: boolean[] = [];
 ...
 * @memberof utils
 */
function pick(o: Record<string, any>, props: any[] = []) {
 ...
 * @memberof utils
 */
function antiPick(o: Record<string, any>, props: any[] = []) {
