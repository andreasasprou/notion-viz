...
import { deepEquals, optionalToString } from 'app/graph/utils/utils';
...
const mapItemProperties = (itemProperties: any) =>
  itemProperties
    .sort(({ key: keyA }: any, { key: keyB }: any) => (keyA < keyB ? -1 : keyA === keyB ? 0 : 1))
    .map((prop: any, i: any) => (
...
export class InspectorComponent extends Component<any, InspectorComponentState> {
  footerRowElem: any;
